...
<title>gallery Navigation Bar</title>
</head>
...
<ul class="ul1">
    ...
    <li class="li1 "><a href="gallery.php" name="gallery" onclick="change()"><span class="span1">Gallery</span></a></li>
    	<div class="dropdown-content">
    		<a href="gallery.php#photos">Photos</a>
        </div>
    </div>
    <div class="dropdown">
    ...
    <li class="li1"><a href="contact_us.php"><span class="span1">Contact Us</span></a></li>
        ...
        <div class="dropdown">
  	<li class="li1 active"><a href="chatbox.php"><span class="span1">Chat_box</span></a></li>
    </div>
    </div>
  ...
  <!-- <button id="gallery_totop" onclick="topFunction()"><img src="images/top.jpg" width="50px" height="50px"/></button>
<script src="javascript/gallery_totop.js"></script>   -->
</body> 
</html>